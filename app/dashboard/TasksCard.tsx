    ...
    <section className="rounded-[28px] border border-gray-200/80 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-gray-400">
            Synced securely with your Orenios account
          </p>
        </div>
      ...
      >
        <input
          ...
          maxLength={120}
          disabled={addingTask}
          className="h-12 min-w-0 flex-1 rounded-2xl border border-gray-200 bg-gray-50 px-4 text-sm text-gray-950 outline-none transition placeholder:text-gray-400 focus:border-violet-400 focus:bg-white focus:ring-4 focus:ring-violet-100 disabled:cursor-not-allowed disabled:opacity-60"
        />

        <motion.button
          whileHover={addingTask ? undefined : { scale: 1.02 }}
          whileTap={addingTask ? undefined : { scale: 0.98 }}
          type="submit"
          disabled={addingTask || !newTask.trim()}
          className="flex h-12 shrink-0 items-center justify-center gap-2 rounded-2xl bg-gray-950 px-5 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(15,23,42,0.16)] transition hover:bg-black disabled:cursor-not-allowed disabled:opacity-60"
        >
          {addingTask ? (
            <>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border transition disabled:cursor-wait ${
                      task.completed
        ...
        {!loadingTasks && tasks.length === 0 && (
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-gray-400">
              Add your first task and it will be available across your devices.
            </p>
          </motion.div>
        )}
      </div>
